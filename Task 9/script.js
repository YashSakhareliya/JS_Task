...
async function initializeModel() {
    try {
        classifier = await ml5.imageClassifier('https://teachablemachine.withgoogle.com/models/e-DJHZmpe/', () => {
            isModelLoaded = true;
            modelStatus.textContent = 'DOG VS WOLFS model loaded successfully!';
